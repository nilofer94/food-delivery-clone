  ...
  return (
    <div className="rounded-lg transition ease delay-100  hover:scale-90 duration-100">
      <div className="relative">
        <img
          className="rounded-2xl h-[160] w-full object-cover drop-shadow-md"
      ...
      <h3 className="ml-3 font-bold pt-4 overflow-hidden whitespace-nowrap text-ellipsis">
        {name}
      </h3>
      <h4 className="ml-3 overflow-hidden whitespace-nowrap text-ellipsis font-semibold">
        <span className="pr-1 text-green-700">★</span>
        {avgRating}
        <span className="text-xl pl-1">&bull;</span>
        <span className="pl-1">{sla.slaString}</span>
      </h4>
      <h4 className="ml-3 overflow-hidden whitespace-nowrap text-ellipsis text-gray-500">
        {cuisines.join(",")}
      </h4>
      <h4 className="ml-3 overflow-hidden whitespace-nowrap text-ellipsis text-gray-500">
