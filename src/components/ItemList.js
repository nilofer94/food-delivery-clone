      ...
      {items.map((item) => {
        return (
          <div
            ...
            className="flex justify-between items-center py-4 my-4 border-b border-black-100 last:border-b-0"
          >
            ...
            <div className="px-4 w-3/12">
              <div className="relative">
                <img
                  ...
                  src={DISH_IMAGE_URL + "/" + item.card.info.imageId}
                />
                <div className="absolute w-full -bottom-3">
                  <div className="flex justify-center">
                    <button
                      className="bg-white shadow-lg text-center px-8 py-1 rounded-lg text-green-600 text-lg font-extrabold hover:bg-gray-300"
